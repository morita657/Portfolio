(function() {
  ...
  var v = /:[0-9]+$/,
    x = function(a, b) {
      ...
      if ("protocol" === b || "port" === b)
        a.protocol = w(a.protocol) || w(r.location.protocol);
      "port" === b
        ? (a.port = String(
  ...
  function S(a, b, c) {
    for (var d = {}, e = {}, g = H().decorators, f = 0; f < g.length; ++f) {
      ...
      (!c || h.forms) &&
        G(h.domains, b) &&
        (h.fragment ? m(e, h.callback()) : m(d, h.callback()));
    }
  ...
  function U(a, b, c) {
    b.href &&
      ((a = R(a, b.href, void 0 === c ? !1 : c)), q.test(a) && (b.href = a));
  }
  function T(a, b) {
    if (b && b.action) {
      ...
      if ("get" === c) {
        ...
        "post" === c && ((a = R(a, b.action)), q.test(a) && (b.action = a));
    }
  }
  var V = function(a) {
      try {
        ...
        if (c) {
          var d = c.protocol;
          ("http:" !== d && "https:" !== d) || S(c, c.hostname, !1);
        }
      } catch (e) {}
    },
    W = function(a) {
  ...
  l("google_tag_data.glBridge.decorate", function(a, b, c) {
    ...
    a = M(a);
    if (b.tagName) {
      if ("a" == b.tagName.toLowerCase()) return U(a, b, c);
      if ("form" == b.tagName.toLowerCase()) return T(a, b);
    }
    if ("string" == typeof b) return R(a, b, c);
  });
